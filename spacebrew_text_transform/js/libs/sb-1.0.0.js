...
Spacebrew.Client = function( server, name, description ){
	 ...
	 * @type {String}
	 */
	// this.name		 = name !== undefined ? name : (window.getQueryString('name') !== "" ? getQueryString('name') : "javascript client");

	this.name = name || "javascript client";
	if (window) {
		this.name = (window.getQueryString('name') !== "" ? getQueryString('name') : this.name);
	}
	 ...
	 * @type {String}
	 */
	// this.description = description !== undefined ? description : "spacebrew javascript client";

	this.description = description || "spacebrew javascript client";
	if (window) {
		this.description = (window.getQueryString('description') !== "" ? getQueryString('description') : this.description);
	}
 ...
 * @return {String} Returns the description of the spacebrew app
 */
